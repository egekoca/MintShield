const state = {
  ...
  filter: "all",
  language:
    localStorage.getItem("mintshield-language-v2") === "tr" ? "tr" : "en",
  preview: null,
  summary: null,
  signRequest: null,
  xamanStatus: "idle",
...
const translations = {
  tr: {
    ...
    navTest: "Akışı test et",
    navEvidence: "Kanıtlar",
    heroEyebrow: "Flare Smart Accounts için güvenli yürütme",
    ...
    fullSimulation: "Tam çağrı simülasyonu",
    exactFallback: "Exact FXRP fallback",
    protectionPrinciple: "Yürütme değişmezi",
    or: "veya",
    ...
    now: "şimdi",
    offline: "çevrimdışı",
    journeyEyebrow: "Tek ödeme. Tek korumalı sonuç.",
    journeyTitle: "XRP ödemesinden güvenli yürütmeye.",
    journeyBody:
      "MintShield planlama, cüzdan onayı, protokol kanıtı ve uygulama yürütmesini görünür biçimde ayırır. Her kapının net bir görevi vardır.",
    flowStagePlan: "PLANLA",
    flowPlanTitle: "Intent’i ön izle",
    flowPlanBody: "Canlı Coston2 fee ve nonce değerlerini oku. Hiçbir şey imzalanmaz veya gönderilmez.",
    readOnly: "SALT OKUNUR",
    flowStageSign: "YETKİLENDİR",
    flowSignTitle: "Xaman’da imzala",
    flowSignBody: "Commit edilmiş 0xFE talimatını taşıyan tek XRPL Testnet ödemesini incele.",
    externalWallet: "HARİCİ CÜZDAN",
    flowStageProve: "DOĞRULA",
    flowProveTitle: "Ödemeyi kanıtla",
    flowProveBody: "Executor XRPL alanlarını doğrular ve FDC ödeme kanıtını bekler.",
    flowStageSimulate: "KAPI",
    flowSimulateTitle: "Tam çağrıyı simüle et",
    flowSimulateBody: "Kanıt oluşturulduktan sonra aynı eth_call yayın öncesinde geçmek zorundadır.",
    flowStageSettle: "SONUÇLANDIR",
    flowSettleTitle: "Güvenli sonucu al",
    flowSettleBody: "Başarıda vault share; aksi durumda Personal Account’ta exact FXRP fallback.",
    protectedOutcome: "KORUMALI SONUÇ",
    testPathQuick: "HIZLI ÜRÜN TESTİ",
    availableNow: "ŞİMDİ HAZIR",
    quickTestTitle: "Tarayıcıda güvenle keşfet",
    quickTestBody: "Herhangi bir XRPL Testnet public adresi kullan, canlı intent ön izlemesi oluştur ve fee, nonce, fallback ile commitment’ı incele. Cüzdan imzası gerekmez; fon hareket etmez.",
    startPreview: "Ön izlemeyi başlat",
    testPathFull: "TAM TESTNET SETTLEMENT",
    operatorMode: "OPERATÖR MODU",
    fullTestTitle: "Uçtan uca Xaman akışını çalıştır",
    fullTestBody: "Durable status API ve executor worker’ı çalıştır, üretilen ödemeyi Xaman Testnet’te imzala ve XRPL → FDC → simülasyon → Flare settlement akışını izle.",
    openRunbook: "Test rehberini aç",
    reviewEyebrow: "Canlı Coston2 ürün testi",
    reviewTitle: "İmzadan önce her alanı bil.",
    reviewBody:
      "Public XRPL Testnet adresini gir. MintShield güncel protokol değerlerini okur ve seed istemeden ya da fon hareket ettirmeden insan tarafından okunabilir bir commitment üretir.",
  ...
  en: {
    navHow: "How it works",
    navTest: "Test the flow",
    navEvidence: "Evidence",
    heroEyebrow: "Execution safety for Flare Smart Accounts",
    ...
    fullSimulation: "Full-call simulation",
    exactFallback: "Exact FXRP fallback",
    protectionPrinciple: "Execution invariant",
    or: "or",
    ...
    now: "now",
    offline: "offline",
    journeyEyebrow: "One payment. One protected outcome.",
    journeyTitle: "From XRP payment to safe execution.",
    journeyBody:
      "MintShield keeps planning, wallet approval, protocol proof and application execution visibly separate. Every gate has a clear job.",
    flowStagePlan: "PLAN",
    flowPlanTitle: "Preview the intent",
    flowPlanBody: "Read live Coston2 fees and nonce. Nothing is signed or submitted.",
    readOnly: "READ ONLY",
    flowStageSign: "AUTHORIZE",
    flowSignTitle: "Sign in Xaman",
    flowSignBody: "Review one XRPL Testnet payment carrying the committed 0xFE instruction.",
    externalWallet: "EXTERNAL WALLET",
    flowStageProve: "VERIFY",
    flowProveTitle: "Prove the payment",
    flowProveBody: "The executor validates XRPL fields and waits for the FDC payment proof.",
    flowStageSimulate: "GATE",
    flowSimulateTitle: "Simulate the full call",
    flowSimulateBody: "An exact eth_call must pass after proof construction before broadcast.",
    flowStageSettle: "SETTLE",
    flowSettleTitle: "Receive a safe result",
    flowSettleBody: "Vault shares on success, or the exact FXRP fallback in the Personal Account.",
    protectedOutcome: "PROTECTED OUTCOME",
    testPathQuick: "QUICK PRODUCT TEST",
    availableNow: "AVAILABLE NOW",
    quickTestTitle: "Explore safely in the browser",
    quickTestBody: "Use any XRPL Testnet public address, create a live intent preview and inspect fees, nonce, fallback and commitment. No wallet signature and no funds move.",
    startPreview: "Start preview",
    testPathFull: "FULL TESTNET SETTLEMENT",
    operatorMode: "OPERATOR MODE",
    fullTestTitle: "Run the end-to-end Xaman flow",
    fullTestBody: "Run the durable status API and executor worker, sign the generated payment in Xaman Testnet, then follow XRPL → FDC → simulation → Flare settlement.",
    openRunbook: "Open runbook",
    reviewEyebrow: "Live Coston2 product test",
    reviewTitle: "Know every field before signing.",
    reviewBody:
      "Enter a public XRPL Testnet address. MintShield reads current protocol values and builds a human-readable commitment without asking for a seed or moving funds.",
...
function applyLanguage(language) {
  ...
  localStorage.setItem("mintshield-language-v2", state.language);
